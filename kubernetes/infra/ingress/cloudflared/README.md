...
- Egress permits cluster DNS, the HTTPS listener of the named Cilium Gateway Service, and Cloudflare on TCP or
  UDP `7844` with TCP `443` for management and fallback.
